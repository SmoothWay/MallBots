...
const file_notificationspb_api_proto_rawDesc = "" +
	"\n" +
	"\x19notificationspb/api.proto\x12\x0fnotificationspb\x1a\x1enotificationspb/messages.proto\"W\n" +
	...
	"\vcustomer_id\x18\x02 \x01(\tR\n" +
	"customerId\"\x1a\n" +
	"\x18NotifyOrderReadyResponse2\xdf\x02\n" +
	"\x13NotificationService\x12m\n" +
	"\x12NotifyOrderCreated\x12*.notificationspb.NotifyOrderCreatedRequest\x1a+.notificationspb.NotifyOrderCreatedResponse\x12p\n" +
	"\x13NotifyOrderCanceled\x12+.notificationspb.NotifyOrderCanceledRequest\x1a,.notificationspb.NotifyOrderCanceledResponse\x12g\n" +
	"\x10NotifyOrderReady\x12(.notificationspb.NotifyOrderReadyRequest\x1a).notificationspb.NotifyOrderReadyResponseB\xb8\x01\n" +
...
var file_notificationspb_api_proto_depIdxs = []int32{
	0, // 0: notificationspb.NotificationService.NotifyOrderCreated:input_type -> notificationspb.NotifyOrderCreatedRequest
	2, // 1: notificationspb.NotificationService.NotifyOrderCanceled:input_type -> notificationspb.NotifyOrderCanceledRequest
	4, // 2: notificationspb.NotificationService.NotifyOrderReady:input_type -> notificationspb.NotifyOrderReadyRequest
	1, // 3: notificationspb.NotificationService.NotifyOrderCreated:output_type -> notificationspb.NotifyOrderCreatedResponse
	3, // 4: notificationspb.NotificationService.NotifyOrderCanceled:output_type -> notificationspb.NotifyOrderCanceledResponse
	5, // 5: notificationspb.NotificationService.NotifyOrderReady:output_type -> notificationspb.NotifyOrderReadyResponse
